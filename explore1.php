...
<?php
            ...
            $car_id=$_GET['rent_id'];
            $get_det="select * from rent where rent_id='$rent_id'";
            $run_det=mysqli_query($con,$get_det);
            while($row_car=mysqli_fetch_array($run_det))
           {
          $rent_id=$row_car['rent_id'];
          $rent_name=$row_car['r_name'];
          $rent_cat=$row_car['cat_id'];
          $rent_comp=$row_car['comp_id'];
          $rent_desc=$row_car['r_desc'];
          $rent_price=$row_car['r_price'];
          $rent_image=$row_car['r_image'];
          $year=$row_car['year'];
        ...
        <div class='clearfix'>
       <h1 style='  font-size:45px; color:black; font-style: Arial; font-weight:bold;'>$rent_name</h1><br/>
       &nbsp;
       <span  class='round' style='float:right; '>Per Day PKR. $rent_price/-</span>
        </div>
        </div>
        <br>
        <div class='row'>
        <div class='col-md-12 col-md-8'>
        <img src='admin_area/rent_car_image/$rent_image' id='myImg' class='img-responsive' height='70%' width='100%'>
        <br />
       ...
       <img class='modal-content' id='img01'>
        ...
        <h2 style='font-weight:bold; font-size:35px; color:black; margin-top:-40PX;'>PRICE: $rent_price/-</h2>
        <br>
        <div class='well well-large'>
        <p  id='desc'>$rent_desc</p>
        </div>
        <br>
        </div>
        ...
        <li class='list-group-item'> <span class='badge'>Model</span>$rent_name</li>
       ...
       &nbsp;
       <a href='rentnow.php?rent=$rent_id' type='button' id='buy' role='button' class='btn btn-secondary btn-lg btn-block'>RENT A CAR</a>
           <br>
        </div>
